'''
this code was copied from the web. can generate venn diagramms for 2,3 or 4 data lists.
the round/elipses sizes are not proportional to the data
'''
...
#--------------------------------------------------------------------
def venn(ax, data, names=None, fill="number", show_names=True, show_plot=True, **kwds):
    """
    data: a list
    ...
    if len(data) == 2:
        venn2(ax,data, names, fill, show_names, show_plot, **kwds)
    elif len(data) == 3:
        venn3(ax, data, names, fill, show_names, show_plot, **kwds)
    elif len(data) == 4:
        venn4(ax, data, names, fill, show_names, show_plot, **kwds)
    else:
...
#--------------------------------------------------------------------
def venn2(ax,data=None, names=None, fill="number", show_names=True, show_plot=True, **kwds):
...
#--------------------------------------------------------------------
def venn3(ax, data=None, names=None, fill="number", show_names=True, show_plot=True, **kwds):
...
#--------------------------------------------------------------------
def venn4(ax, data=None, names=None, fill="number", show_names=True, show_plot=False, **kwds):
...
#     # venn4()
    ...
    pylab.subplots(3,1)  
    venn(1,[range(10), range(20,25), range(3,8), range(4,9)], ["aaaa", "bbbb", "cccc", "dddd"], figsize=(12,12))
    pylab.show()
#--------------------------------------------------------------------
