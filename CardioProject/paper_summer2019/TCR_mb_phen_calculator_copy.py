...
phen_name = 'any_outcome'
phen_col = 'any_outcome'
phen_file = CARDIO_PHEN_DIR + 'outcomeDF.xlsx'
...
FDR_lim_species_phen = 0.2
nTOP_species_phen = None
FDR_lim_cluster_phen = 0.05
nTOP_cluster_phen = None
FDR_lim_cluster_species = 0.25
nTOP_cluster_species = None
FDR_for_plotting = 0.25

sample_list1_name = 'Cardio126_any_outcome00'
sample_list1_file = 'Cardio126_any_outcome00.pkl'
sample_list2_name = 'Cardio126_any_outcome11'
sample_list2_file = 'Cardio126_any_outcome11.pkl'
...
def get_shared_data_for_2_sample_lists(data_df, sample_list1, sample_list2,
    ...
    for n, sample_list in enumerate([sample_list1, sample_list2]):
        ...
        if data.min().min() == 0.0001:
            data = data.replace(0.0001, np.nan)
